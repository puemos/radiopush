      ...
      <div class="border-t-2 border-gray-700 border-opacity-30">
        <div class="flex flex-col items-center">
          <div class="flex flex-row items-center space-x-2">
            <span>
              <.link navigate="/legal" class="text-white hover:text-gray-100 py-2 rounded-md text-sm font-medium">
                Legal
              </.link>
            </span>
            ...
            <span class="my-2">
              <.link
                href="mailto:radiopush.app@gmail.com"
          ...
          <div class="text-center py-2">
            <p class="text-sm text-gray-300 mb-2">
              © 2021 Made with 🎶 by
              <a class="sp-underline primary hover:text-white" href="https://github.com/puemos">Shy Alter</a>
            </p>
          </div>
        </div>
      </div>
