  ...
  def render(assigns) do
    ...
    <nav class="flex flex-row justify-between items-center w-full top-0 left-0 z-50 py-3">
      <div class="flex space-x-4 items-baseline">
        <.link navigate="/" class="py-2 rounded-md">
      ...
      <div class="flex space-x-4">
        <div class="relative" id="menu" data-id="menu" data-event="click-outside-user-menu">
          <div
            :if={@current_user}
            phx-click="open-menu"
            class="cursor-pointer flex flex-row items-center space-x-2 rounded-3xl bg-gray-700 capitalize text-gray-100 py-1 px-2 text-sm font-bold"
          >
          ...
          <div :if={@menu_open} class="z-50 absolute right-0 w-40 mt-2 bg-gray-700 rounded shadow-xl">
            <.link href={Routes.user_session_path(@socket, :delete)}>
