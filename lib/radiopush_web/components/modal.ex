defmodule RadiopushWeb.Components.Modal do
  ...
  def render(assigns) do
    ~H"""
    <div id={{"modal-#{@title}"}} phx-hook="ScrollLock" class={{"z-50 fixed w-full h-full md:bg-opacity-50 bg-gray-800 top-0 left-0 md:py-10 flex justify-center items-center"}}>
